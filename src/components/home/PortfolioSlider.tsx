      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-8 mb-16">
          <div className="flex gap-3 order-2 md:order-1">
            <button className="w-12 h-12 rounded-full bg-primary flex items-center justify-center text-white"><ChevronLeft size={24} /></button>
            <button className="w-12 h-12 rounded-full bg-primary flex items-center justify-center text-white"><ChevronRight size={24} /></button>
          </div>
          <div className="flex flex-col items-start md:items-end text-left md:text-right max-w-2xl order-1 md:order-2">
            <Reveal>
              ...
              <h2 className="text-3xl md:text-5xl font-black text-black uppercase tracking-tight">Kefee Home Productions x Z2 Concepts</h2>
            </Reveal>
          </div>
        </div>
            ...
            <Reveal key={i}>
              <div className="group cursor-pointer">
                ...
                <div className={`p-8 rounded-[24px] flex items-center justify-between ${work.active ? "bg-[#FF6B35] text-white" : "bg-white text-black border border-black/5"}`}>
                  <h3 className="text-xl font-bold uppercase leading-tight">{work.title}</h3>
