...
export default function IntroStatement() {
  return (
    <section className="pt-24 pb-10 md:pt-32 md:pb-12 px-6 md:px-12 bg-[#FDF8F0] text-center">
      <div className="max-w-5xl mx-auto">
        <Reveal>
          <h2 className="text-2xl md:text-5xl font-bold text-black leading-[1.3] tracking-tight uppercase">
