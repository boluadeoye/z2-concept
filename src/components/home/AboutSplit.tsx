...
export default function AboutSplit() {
  return (
    <section className="pb-24 md:pb-40 pt-0 px-6 md:px-12 bg-[#FDF8F0]">
            ...
            <Reveal className="h-full">
              <div className="bg-white rounded-[48px] p-10 lg:p-16 shadow-[0_30px_80px_-15px_rgba(0,0,0,0.05)] border border-black/5 flex flex-col h-full">
                <div className="flex gap-4 mb-12">
                  <div className="flex items-center gap-2 px-5 py-2.5 rounded-full border border-black text-black text-[10px] font-bold uppercase tracking-widest">
                ...
                <p className="text-black/70 text-sm lg:text-base leading-relaxed mb-12 flex-1">
                  specialises in professional photography and video production, delivering high-quality visuals across a wide range of projects.
                </p>
          ...
          <div className="hidden md:block h-full">
            <Reveal className="h-full">
              <div className="relative h-full w-full rounded-[48px] overflow-hidden shadow-2xl border border-black/5">
                <img src="https://res.cloudinary.com/dwbjb3svx/image/upload/v1781521104/blog_assets/uhkj4l7sck5mdfvfbrpq.png" className="absolute inset-0 w-full h-full object-cover" alt="" />
              </div>
            </Reveal>
          </div>
        </div>
