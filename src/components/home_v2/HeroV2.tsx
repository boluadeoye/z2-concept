    ...
    <section className="relative w-full h-[85vh] md:h-screen bg-[#0C0608] overflow-hidden block">
      <div className="absolute inset-0 w-full h-full group">
        <img 
          ...
          className="w-full h-full object-cover opacity-100 object-[center_25%] transition-transform duration-1000 ease-in-out group-hover:scale-110" 
          alt="Z2 Hero" 
        />
        <div className="absolute inset-0 bg-black/40" />
      </div>

      <div className="relative z-10 h-full w-full max-w-7xl mx-auto px-6 md:px-12 flex flex-col justify-center items-start">
        <div className="max-w-2xl">
          ...
          <p className="text-white/80 text-xs md:text-sm font-bold mb-8 max-w-md leading-relaxed">
